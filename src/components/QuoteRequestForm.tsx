            ...
            {quoteResult && (
                <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-md">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li className="flex justify-between">
                            <span>Fee:</span>
                            <span className="font-medium text-gray-900">{quoteResult.fee}{formData.fromCurrency}</span>
                        </li>
                        <li className="flex justify-between border-t border-gray-200 pt-2 mt-2">
                            ...
                            <span className="font-bold text-gray-800 text-base">{quoteResult.receiveAmount}{formData.toCurrency}</span>
                        </li>
                    </ul>
